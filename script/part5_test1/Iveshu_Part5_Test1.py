        ...
        try:
            ...
            for index, value in enumerate(list_item_key_path):
                ...
                if isinstance(dict_last, list):
                    int_value = Part5Test1Solution()._fmt_int(value)
    ...
    def update_dict(str_json, list_key_path, list_key_value):
        ...
        try:
            ...
            for index, value in enumerate(list_key_path):
                dict_last = Part5Test1Solution()._get_last_dict(dict_info, value)
...
if __name__ == "__main__":
    ...
    dict_update = Part5Test1Solution().update_dict(str_dict_info,
                                                   ["/detail/test/title", "/name", "/detail/part",
                                                       "/list_1/1/name", "/int_key/0"],
