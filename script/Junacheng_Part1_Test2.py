...
class EqualZeroSeqTest:
    ...
    def compute_equal_zero_seq(list_integer_input):
        ...
        set_equal_zero_seq = set()
        res_list_equal_zero_seq = []

        if not isinstance(list_integer_input, list) or len(list_integer_input) < 3:
            return res_list_equal_zero_seq
        ...
        while sorted_list_input[beg] <= 0:
            ...
            while mid < end:
                ...
                if int_sum > 0:
                    ...
                    continue
                if int_sum == 0:
                    set_equal_zero_seq.add((int_beg, int_mid, int_end))
                    mid = mid + 1
                    end = end - 1
                    continue
                if int_sum < 0:
        ...
        return list(sorted(set_equal_zero_seq))
